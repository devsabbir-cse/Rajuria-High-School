...
import committee from '@/file/committee.json';
const Page = () => {
  return (
    <div className='flex justify-between gap-x-[20px]' >
      <div className="w-full mx-auto text-center mt-5">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">শূণ্যপদের তালিকা</h1>
        <div className="" />
        ...
        <table className="w-full border-collapse border border-gray-300 mt-5">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="border p-2">শুন্য পদের সংখ্যা</th>
                    </tr>
                  </thead>
                  <tbody>
                    {committee.map((item) => (
