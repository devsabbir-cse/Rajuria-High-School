          ...
          >
            ...
            {openDropdown === "about" && (
              <ul className="absolute top-full left-0 mt-3 w-64 bg-purple-800 text-white shadow-2xl rounded-md z-50 overflow-hidden animate-fade-in">
                <li>
                  <Link
                    href="/pages/aboutUs/principal-info"
                ...
                {/* <li>
                  <Link
                    href="/pages/aboutUs/students-honor"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কৃতি শিক্ষার্থী
                  </Link>
          ...
          >
            ...
            {openDropdown === "academic" && (
              <ul className="absolute top-full left-0 mt-3 w-64 bg-purple-800 text-white shadow-2xl rounded-md z-50 overflow-hidden animate-fade-in">
                <li>
                  <Link
                    href="/pages/academicData/room-number"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কক্ষ সংখ্যা
                  </Link>
                ...
                <li>
                  <Link
                    href="/pages/academicData/computer-usage"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কম্পিউটার-ব্যবহার
                  </Link>
