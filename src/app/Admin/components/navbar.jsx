...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-800 to-purple-900 text-white shadow-md sticky top-0 z-50 bg-white  flex mx-auto">
      <div className="max-w-7xl flex mx-auto px-6 py-4">
        <ul className="flex items-center font-semibold text-[16px] relative  rounded-md ">
          ...
          >
            ...
            {openDropdown === "about" && (
              <ul className="absolute top-full left-0 mt-3 w-64 bg-purple-800 text-white shadow-2xl rounded-md z-50 overflow-hidden animate-fade-in">
                ...
                {/* <li>
                  <Link
                    href="/User/pages/aboutUs/students-honor"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কৃতি শিক্ষার্থী
                  </Link>
          ...
          >
            ...
            {openDropdown === "academic" && (
              <ul className="absolute top-full left-0 mt-3 w-64 bg-purple-800 text-white shadow-2xl rounded-md z-50 overflow-hidden animate-fade-in">
                <li>
                  <Link
                    href="/User/pages/academicData/room-number"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কক্ষ সংখ্যা
                  </Link>
                ...
                <li>
                  <Link
                    href="/User/pages/academicData/computer-usage"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    কম্পিউটার-ব্যবহার
                  </Link>
                ...
                <li>
                  <Link
                    href="/User/pages/academicData/entry-post-list"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    শূণ্যপদের তালিকা
                  </Link>
                ...
                <li>
                  <Link
                    href="/User/pages/academicData/holiday-list"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    ছুটির তালিকা
                  </Link>
                ...
                <li>
                  <Link
                    href="/User/pages/academicData/extracurricular"
                    className="block px-6 py-3 hover:bg-purple-900"
                  >
                    সহপাঠ
                  </Link>
          ...
          {/* <li className="px-4  border-r border-white/30">
            <Link
              href="/User/pages/postNews"
              className="hover:text-yellow-300 transition"
            >
              সাম্প্রতিক খবর
            </Link>
          </li> */}
          <li className="px-4 border-white/30">
            <Link
